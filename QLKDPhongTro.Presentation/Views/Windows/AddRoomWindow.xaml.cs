    ...
    public partial class AddRoomWindow : Window
    {
        ...
        private void AddRoomButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                // TODO: Thêm logic lưu phòng vào database
                // Ở đây bạn có thể gọi service hoặc repository để lưu dữ liệu
                
                // Hiển thị thông báo thành công
                MessageBox.Show($"Đã thêm phòng '{roomName}' thành công!", "Thành công", 
            ...
            {
                MessageBox.Show($"Lỗi khi thêm phòng: {ex.Message}", "Lỗi", 
